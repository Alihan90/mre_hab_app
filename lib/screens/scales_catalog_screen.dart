  ...
  final List<Map<String, dynamic>> _pediatricScales = [
    {
      ...
      "items": [
        ...
        {"id": "WeeFIM", "name": "WeeFIM", "desc": "Оцінка функціональної незалежності дитини та обмежень життєдіяльності."},
        {"id": "PEDI", "name": "PEDI", "desc": "Опитувальник оцінки функціонального стану та обмежень життєдіяльності у дітей."},
        {"id": "HFMSE", "name": "HFMSE", "desc": "Моторна шкала Хаммерсміта для пацієнтів зі спінальною м'язовою атрофією (СМА)."},
        {"id": "CHOP_INTEND", "name": "CHOP INTEND", "desc": "Тест дитячих нейром'язових порушень для оцінки немовлят зі СМА 1-го типу."},
        ...
        {"id": "AIMS", "name": "AIMS (Alberta Infant Motor Scale)", "desc": "Оцінка моторного розвитку немовлят від народження до моменту самостійної ходьби."},
  ...
  final List<Map<String, dynamic>> _adultScales = [
    {
      ...
      "items": [
        ...
        {"id": "MRS", "name": "mRS (Модифікована шкала Ренкіна)", "desc": "Оцінка ступеня інвалідизації або залежності у повсякденному житті після інсульту."},
        ...
        {"id": "FMA", "name": "Fugl-Meyer Assessment (FMA)", "desc": "Глибока та детальна оцінка моторного відновлення, чутливості та болю після інсульту."},
        ...
        {"id": "TINETTI", "name": "Тест Tinetti", "desc": "Оцінка рухливості, темпу ходьби та рівноваги у пацієнтів похилого віку."},
        {"id": "TUG", "name": "Тест TUG (Timed Up and Go)", "desc": "Функціональний швидкісний тест 'Встань та йди' для виявлення ризиків падінь пацієнта."},
    ...
    },
    {
      ...
      "items": [
        {"id": "KARNOFSKY", "name": "Шкала Карновського", "desc": "Оцінка загальної соматичної активності пацієнта від 0% (смерть) до 100% (норма)."},
        {"id": "ECOG", "name": "Шкала ECOG-WHO", "desc": "Міжнародна шкала оцінки загальної активності та ступеня працездатності хронічного пацієнта."},
        ...
        {"id": "ZBI", "name": "Zarit Burden Interview (ZBI)", "desc": "Опитувальник для оцінки фізичного та психологічного навантаження на опікунів пацієнта."}
      ]
    }
  ];
